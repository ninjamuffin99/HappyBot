...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/slot_still.png", __ASSET__assets_images_slot_still_png);
		type.set ("assets/images/slot_still.png", AssetType.IMAGE);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/images/slot_still.png";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_slot_still_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:image("assets/images/slots.png") #if display private #end class __ASSET__assets_images_slots_png extends lime.graphics.Image {}
@:image("assets/images/slot_still.png") #if display private #end class __ASSET__assets_images_slot_still_png extends lime.graphics.Image {}
